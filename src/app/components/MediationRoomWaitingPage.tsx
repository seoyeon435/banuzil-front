  ...
  return (
    <>
      ...
      <div className="min-h-[calc(100vh-80px)] bg-[#FFF8F4] flex items-center justify-center py-12 px-6">
        <div className="w-full max-w-[640px] bg-white rounded-2xl p-10 shadow-[0_8px_32px_rgba(255,99,71,0.17)] text-center">
          ...
          <p className="text-[#FF6347] text-xl font-semibold mb-3">
          ...
          <div className="bg-[#FFE9DD] border border-[#FFD19A] rounded-xl p-4 mb-6 text-left">
            <p className="text-sm font-semibold text-[#1F1410] mb-1">진행 순서</p>
            <p className="text-xs text-[#7A5C4D]">1. 상대방에게 방 번호를 전달해주세요.</p>
            <p className="text-xs text-[#7A5C4D]">2. 상대방이 방 참여하기를 완료한 뒤 입장 작성 화면으로 이동하세요.</p>
          </div>
          ...
          <button
            ...
            className={`w-full h-14 rounded-full font-medium transition-all ${
              isRealSewingSessionId(sessionId)
                ? "bg-[#FFE0CC] text-[#1F1410] hover:bg-[#F0DFD0]"
                : "bg-[#F0DFD0] text-[#7A5C4D] cursor-not-allowed"
            }`}
          >
            시연용: 상대방 참여 완료 처리
