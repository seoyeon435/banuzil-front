      ...
      <div className="max-w-[820px] mx-auto">
        ...
        <div className="bg-white rounded-2xl p-10 shadow-[0_12px_48px_rgba(255,99,71,0.2)] mb-8">
            ...
            <div className="space-y-3">
              <div className="bg-[#FFF8F4] border-l-4 border-[#FF6347] rounded-lg p-5">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-7 h-7 rounded-full bg-[#FFB89A] ring-2 ring-[#FF6347] flex items-center justify-center text-xs font-bold text-[#1F1410]">박</div>
                  <span className="font-semibold text-[#1F1410] text-sm">박서연 — 안정형 애착</span>
                </div>
              ...
              <div className="bg-[#FFF8F4] border-l-4 border-[#D4956A] rounded-lg p-5">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-[#1F1410] text-sm">지현 — 불안형 애착</span>
                </div>
          ...
          <div className="mb-8">
            ...
            <div className="bg-[#FFE9DD] rounded-xl p-5">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="font-medium text-[#FF6347] mb-2">박서연의 해석</p>
                  <p className="text-[#7A5C4D]">"여행 제안 = 내 노력을 무시하는 것"</p>
                </div>
                <div>
                  <p className="font-medium text-[#D4956A] mb-2">지현의 해석</p>
            ...
            <div className="bg-[#FF6347]/5 rounded-xl p-5 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-[#7A5C4D]">
                  한쪽(박서연)은 확인받고 싶어 다가가고, 다른 한쪽(지현)은 부담을 느껴 물러나는 패턴이 반복되고 있어요.
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="bg-[#E0F4E8] rounded-xl p-4">
                <p className="font-medium text-[#5A9F7C] mb-2">박서연에게 필요했던 것</p>
                <p className="text-[#1F1410]">노력을 인정받고 싶은 마음, "네가 열심히 하고 있는 거 알아"라는 말</p>
              </div>
              <div className="bg-[#E0F4E8] rounded-xl p-4">
                <p className="font-medium text-[#5A9F7C] mb-2">지현에게 필요했던 것</p>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              <div className="bg-white border border-[#FF6347]/20 rounded-xl p-4">
                <p className="text-xs text-[#7A5C4D] mb-2">박서연 → 지현에게</p>
              ...
              <div className="bg-white border border-[#D4956A]/20 rounded-xl p-4">
                <p className="text-xs text-[#7A5C4D] mb-2">지현 → 박서연에게</p>
                <p className="text-sm text-[#1F1410] leading-relaxed">
