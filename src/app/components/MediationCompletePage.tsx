            ...
            <div className="space-y-3">
              <div className="bg-[#FFF8F4] border-l-4 border-[#FF6347] rounded-lg p-5">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-7 h-7 rounded-full bg-[#FFB89A] ring-2 ring-[#FF6347] flex items-center justify-center text-xs font-bold text-[#1F1410]">{currentInitial}</div>
                  <span className="font-semibold text-[#1F1410] text-sm">{currentName} — 안정형 애착</span>
                </div>
              ...
              <div className="bg-[#FFF8F4] border-l-4 border-[#D4956A] rounded-lg p-5">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-7 h-7 rounded-full bg-[#FFB89A] ring-2 ring-[#D4956A] flex items-center justify-center text-xs font-bold text-[#1F1410]">{partnerInitial}</div>
                  <span className="font-semibold text-[#1F1410] text-sm">{partnerName} — 불안형 애착</span>
                </div>
          ...
          <div className="mb-8">
            ...
            <div className="bg-[#FFE9DD] rounded-xl p-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="font-medium text-[#FF6347] mb-2">{currentName}의 해석</p>
                  <p className="text-[#7A5C4D]">"여행 제안 = 내 노력을 무시하는 것"</p>
                </div>
                <div>
                  <p className="font-medium text-[#D4956A] mb-2">{partnerName}님의 해석</p>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              <div className="bg-white border border-[#FF6347]/20 rounded-xl p-4">
                <p className="text-xs text-[#7A5C4D] mb-2">{currentName} → {partnerName}님에게</p>
              ...
              <div className="bg-white border border-[#D4956A]/20 rounded-xl p-4">
                <p className="text-xs text-[#7A5C4D] mb-2">{partnerName}님 → {currentName}에게</p>
                <p className="text-sm text-[#1F1410] leading-relaxed">
